...
export const DashboardDemo: React.FC = () => {
  return (
    <section id="product" className="py-24 bg-[#0B0F19] relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/10 via-brand-dark to-brand-dark pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                "Visibility Snapshot & Share of Mentions",
                "Top Personas & Context Themes",
                "Model & Region Trends Over Time",
                "Opportunity Map & Gaps",
                "Tracing Panel & Action Queue"
              ].map((item, i) => (
          ...
          {/* Dashboard Mockup */}
          <div className="bg-[#151b2b] border border-slate-800 rounded-xl p-6 shadow-2xl shadow-blue-900/20">
            {/* Header Mockup */}
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-800">
              <div>
                <h4 className="font-bold text-white">EchoScore™</h4>
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="h-48 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data}>
                      ...
                      />
                      <Area type="monotone" dataKey="visibility" stroke="#3B82F6" fillOpacity={1} fill="url(#colorVis)" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#0B0F19] p-4 rounded-lg border border-slate-800">
                   ...
                   <div className="text-xs text-blue-400">Strongest Performance</div>
                </div>
              </div>
